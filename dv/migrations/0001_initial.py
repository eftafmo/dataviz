# Generated by Django 3.2.5 on 2021-09-02 13:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('approved', 'Approved'), ('implementation', 'Implementation'), ('completed', 'Completed'), ('closed', 'Closed'), ('withdrawn', 'Withdrawn'), ('returned', 'Returned to po'), ('cancelled', 'Cancelled')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('signed', 'Signed'), ('planned', 'Planned'), ('in progress', 'In Progress'), ('completed', 'Completed'), ('terminated', 'Terminated'), ('non completed', 'Non Completed'), ('partially completed', 'Partially Completed')], max_length=19)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(db_constraint=False, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='news', to='dv.project')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_of_measurement', models.CharField(choices=[('annual', 'Annual number'), ('number', 'Number')], max_length=8)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('country', 'Country'), ('programme', 'Programme')], max_length=16)),
                ('status', models.CharField(choices=[('completed', 'Completed'), ('compl review fmo', 'Completion under review by FMO'), ('compl review nfp', 'Completion under review by NFP'), ('draft completion', 'Draft Completion'), ('on-going', 'On-going'), ('review fmo', 'Under review by FMO')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thematic', models.CharField(blank=True, choices=[('competitive', 'Competitive'), ('green', 'Green'), ('inclusive', 'Inclusive')], max_length=16)),
