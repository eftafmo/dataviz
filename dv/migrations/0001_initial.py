    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "funding_period",
                    models.IntegerField(
                        choices=[(1, "2004-2009"), (2, "2009-2014"), (3, "2014-2021")]
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_tap",
                    models.BooleanField(help_text="Technical Assistance Programme"),
                ),
                (
                    "is_bfp",
                    models.BooleanField(
                        default=False, help_text="Bilateral Fund Programme"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "programme",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="dv.programme"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "financial_mechanism",
                    models.CharField(
                        choices=[("EEA", "EEA Grants"), ("NOR", "Norway Grants")],
                        max_length=3,
                    ),
                ),
                ("allocation", models.DecimalField(decimal_places=2, max_digits=15)),
                ...
                (
                    "project",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="dv.project"
                    ),
                ),
                (
                    "state",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="dv.state"
                    ),
                ),
            ],
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.CASCADE, to="dv.state"
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "programmes",
                    models.ManyToManyField(related_name="news", to="dv.Programme"),
                ),
                (
                    "project",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            options={
                "unique_together": {
                    ("funding_period", "state", "programme_area", "financial_mechanism")
                },
            },
        ),
    ]
